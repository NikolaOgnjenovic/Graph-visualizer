...
from plugins.datasources.csv.graph.csv.datasource import CsvTreeLoader


def main():
    parser = argparse.ArgumentParser(description="Load a CSV file as a graph and print it.")
    parser.add_argument("csv_path", nargs="?", default=str(Path(__file__).resolve().parents[3] / "data/csv/test.csv"), help="Path to CSV file to load")
